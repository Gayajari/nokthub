...
function injectCommentToggleStyles() {
  ...
  style.textContent = `
    ...
    .comment-preview{display:flex;align-items:flex-start;gap:8px;font-size:.78rem;
      line-height:1.35;color:var(--text-muted);max-width:100%;margin-top:4px}
    .comment-preview-avatar{width:22px;height:22px;border-radius:50%;object-fit:cover;
      flex-shrink:0;margin-top:1px}
    .comment-preview-body{flex:1;min-width:0;overflow:hidden}
    .comment-preview-name{font-weight:600;color:var(--text-primary,#fff);font-size:.76rem;
      overflow-wrap:anywhere;word-break:break-word}
    .comment-preview-date{font-weight:400;color:var(--text-muted);font-size:.7rem}
    .comment-preview-text{margin-top:1px;overflow:hidden;text-overflow:ellipsis;
